...
class ListHeroAdapter(val listHero: ArrayList<Hero>) : RecyclerView.Adapter<ListHeroAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.tvDetail.text = hero.bio

        holder.itemView.setOnClickListener { onItemClickCallback.onItemClicked(holder.adapterPosition, listHero[holder.adapterPosition]) }
    }
    ...
    interface OnItemClickCallback {
        fun onItemClicked(position: Int, data: Hero)
    }
